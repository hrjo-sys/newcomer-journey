...
function EmployeeDetailModal({ emp, onClose, onOpenJourneyLog, onEdit }) {
...
export default function NewcomerJourneyApp() {
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "var(--bg)", color: "var(--ink)" }} className="min-h-screen w-full relative">
      ...
      {view === "home" && (
        <div className="px-8 pt-10 pb-24">
          ...
          {/* floating add button, bottom right, 2x the avatar pin size (30px -> 60px) */}
          <button
